...
<body>
<div class="nav" class="container-fluid">
    <div class="top">
        ToDo Application
    </br>
        <g:link controller="home" action="completedTask" class="btn btn-warning pull-left  bottom-right">View Completed Task</g:link>
    </br>
    </div>
</div>
